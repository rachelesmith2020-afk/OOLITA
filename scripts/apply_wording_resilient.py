...
The original patch contains the reviewed old/new sentence pairs. This wrapper
keeps those exact pairs, but treats an old phrase appearing one or more times as
valid and replaces every occurrence. It still fails if a target page is missing
or if neither the old nor reviewed wording exists.
"""
