...
for path, form_id, privacy_href in follow_pages:
    ...
    if 'autocomplete="email"' in s:
        raise SystemExit(f"Browser autofill invitation remains in {path}")
