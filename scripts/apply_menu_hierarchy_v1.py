...
def patch(path: str, *, language: str) -> None:
    ...
    # Rename the undifferentiated secondary heading without touching the three
    # primary 01–03 cards above it.
...
# Preserve every existing secondary destination. This pass may group them, but
# it must not silently prune the navigation.
for rel, hrefs in {
    "index.html": (
