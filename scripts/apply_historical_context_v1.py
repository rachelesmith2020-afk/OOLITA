...
('El laberinto de piedra está en Los Escullos. No lo señalizamos ni lo promocionamos como destino: la misma senda se camina en el libro y, desde el 3 de enero, en el mundo 3D.', 'El laberinto de piedra de 2021 forma parte de la historia de OOLITA. Su documentación no es una invitación a visitarlo. La misma senda continúa en el libro y, desde el 3 de enero, en el mundo 3D.'),
('The stone labyrinth is at Los Escullos. We do not sign it or promote it as a destination: the same path is walked in the book and, from 3 January, in the 3D world.', 'The stone labyrinth made in 2021 is part of OOLITA’s history. Its documentation is not an invitation to visit. The same path continues in the book and, from 3 January, in the 3D world.'),
('AHORA · laberinto en Los Escullos · 22 domingos.', 'AHORA · archivo del proyecto · 22 domingos.'),
('NOW · labyrinth at Los Escullos · 22 Sundays.', 'NOW · project archive · 22 Sundays.'),
...
('Está en terreno junto a las dunas fósiles. Se camina despacio.', 'La obra se documentó en terreno junto a las dunas fósiles. Esta página conserva su historia.'),
('It stands on land beside the fossil dunes. You walk it slowly.', 'The work was documented on land beside the fossil dunes. This page records its history.'),
...
('Nada lo señala sobre el terreno: quien pasa por allí lo encuentra o no lo encuentra.', 'Las fotografías y los dibujos conservan el registro de aquella obra.'),
('Nothing marks it on the ground: you either notice it or walk past.', 'Photographs and drawings preserve the record of that work.'),
('OOLITA seguirá teniendo un solo laberinto: el de Los Escullos.', 'OOLITA conserva la memoria del laberinto creado en Los Escullos en 2021.'),
('OOLITA will continue to have one labyrinth: the one at Los Escullos.', 'OOLITA preserves the record of the labyrinth created at Los Escullos in 2021.'),
...
('El laberinto se queda en Los Escullos.', 'El laberinto de 2021 queda documentado en el archivo del proyecto.'),
('The labyrinth stays at Los Escullos.', 'The 2021 labyrinth is documented in the project archive.'),
('Lo que se queda aquí.', 'La memoria del lugar.'),
('What stays here.', 'The memory of the place.'),
('Solo habrá un laberinto OOLITA: el de Los Escullos.', 'El laberinto de Los Escullos de 2021 es el origen documentado de OOLITA.'),
...
('Son parte de cómo nació la obra y de por qué sigue allí.', 'Son parte de cómo nació la obra y de su documentación.'),
...
('Oolita es un laberinto clásico de tres metros, trazado a mano con piedras sueltas en 2021. El entorno es frágil: permanece en los senderos y deja las piedras donde están.', 'Oolita nació de un laberinto clásico de tres metros, trazado a mano con piedras sueltas en 2021. Este archivo documenta la obra original; no ofrece acceso a la instalación.'),
]

NOTICE_ES = '<p class="parr" data-oolita-archive-context>Esta página documenta la obra creada en 2021. No ofrece visitas ni confirma el estado actual o la accesibilidad de la instalación. El proyecto continúa en el libro y en el mundo digital.</p>'
NOTICE_EN = '<p class="parr" data-oolita-archive-context>This page documents the work created in 2021. It does not offer visits or confirm the installation’s current condition or accessibility. The project continues in the book and the digital world.</p>'
changed = 0
