...
('Nada lo señala sobre el terreno: quien pasa por allí lo encuentra o no lo encuentra.', 'Nunca se señalizó.'),
('Nothing marks it on the ground: you either notice it or walk past.', 'It was never signposted.'),
