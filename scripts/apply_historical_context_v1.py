...
('Nada lo señala sobre el terreno: quien pasa por allí lo encuentra o no lo encuentra.', 'Nada lo señala sobre el terreno: quien pasa por allí lo encuentra o no lo encuentra.'),
('Nothing marks it on the ground: you either notice it or walk past.', 'Nothing marks it on the ground: you either notice it or walk past.'),
