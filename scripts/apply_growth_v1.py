...
required = {
    ...
    "cabo-de-gata/index.html": ["Observar", "Hallado, no tomado", "Relaciones reales, no logotipos"],
    "en/cabo-de-gata/index.html": ["Observe", "Found, not taken", "Real relationships, not logos"],
