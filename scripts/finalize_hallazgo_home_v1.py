...
# The 404 directory mirror can persist independently of the dedicated 404.html
# generated by the SEO layer. Normalize any known Hallazgo summary there too.
MIRROR_COPY = {
    "404/index.html": {
        "sources": (
            "Una edición en tapa dura que reúne el cuerpo completo de la obra · catálogo completo en el castillo con clave · 16.09.27 · presentación pública 19.09.27 ↗",
...
def normalize_summary(text: str, sources: tuple[str, ...], final: str, rel: str) -> str:
    """Accept the approved summary or exactly one known historical source."""
...
for rel, cfg in HOME_COPY.items():
    ...
    text = normalize_summary(text, cfg["sources"], cfg["new"], rel)
...
print(
    "Hallazgo final homepage gate passed: concise publication summary current; exact Art anchors point to 3D; "
    "exact catalogue anchors point to catalogue; no Canva or keyed-castle stragglers; no internal 404s; sitemap valid."
)
