...
patched = patched.replace(mirror_line, mirror_line + 'python3 scripts/repair_posters_archive_v1.py site\\n'.replace('\\n', chr(10)) + 'python3 scripts/apply_historical_context_v1.py site --restore\\n'.replace('\\n', chr(10)) + bridge, 1)
